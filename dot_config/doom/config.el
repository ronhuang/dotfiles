...
(setq doom-font (font-spec :family "FantasqueSansMono NF" :size 12.0)
      doom-variable-pitch-font (font-spec :family "Cambria" :size 12.0)
      doom-unicode-font (font-spec :family "Microsoft JhengHei" :size 12.0))
